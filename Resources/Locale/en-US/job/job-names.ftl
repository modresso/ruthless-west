...
# Wild West roles
job-name-cowboy = Cowboy
job-name-lawman = Lawman
job-name-sheriff = Sheriff
job-name-county-sheriff = County Sheriff
job-name-bandit = Bandit
job-name-slave = Slave
job-name-robber = Robber
...
JobLawman = Lawman
JobSheriff = Sheriff
JobCountySheriff = County Sheriff
JobBandit = Bandit
JobSlave = Slave
JobRobber = Robber
