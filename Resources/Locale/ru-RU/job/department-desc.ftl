...
department-Law-description = Поддерживайте порядок и справедливость на Диком Западе.
department-Outlaw-description = Живите вне закона и берите то, что хотите.
