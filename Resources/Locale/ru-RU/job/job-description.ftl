...
# Wild West роли
job-description-cowboy = Свободный дух, странствующий по дикому фронтиру. Делай что хочешь, партнёр.
job-description-lawman = Соблюдайте закон и поддерживайте порядок в этих краях.
job-description-sheriff = Главный законник в городе. Держите преступников в узде.
job-description-county-sheriff = Высшая власть в округе. Ваше слово — закон.
job-description-bandit = Забирай то, что хочешь, у тех, у кого слишком много.
job-description-slave = Пленённая душа, пытающаяся выжить ещё один день.
job-description-robber = Профессиональный преступник, жаждущий крупной добычи.
