...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
            ...
            MarkingManager markings)
        {
            ...
            // Initialize readonly fields before try-catch
            ...
            {
                _sawmill.Error($"Failed to initialize profile editor: {e}");
            }
        }
        ...
        private void InitializeEditor()
        {
            ...
            {
                _sawmill.Error($"Failed to refresh antags: {e}");
            }
            ...
            {
                _sawmill.Error($"Failed to refresh jobs: {e}");
            }
        ...
        public void SetProfile(HumanoidCharacterProfile? profile, int? slot)
        {
            try
            {
                SetProfileInternal(profile, slot);
            }
            catch (Exception e)
            {
                _sawmill.Error($"Failed to set profile: {e}");
            }
        }

        private void SetProfileInternal(HumanoidCharacterProfile? profile, int? slot)
        {
